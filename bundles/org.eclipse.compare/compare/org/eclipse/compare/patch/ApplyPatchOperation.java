...
import org.eclipse.compare.internal.ui.patch.PatchWizard;
import org.eclipse.compare.internal.ui.patch.PatchWizardDialog;
...
public class ApplyPatchOperation implements Runnable {
	...
	public static boolean isPatch(IStorage storage) throws CoreException {
		return PatchParser.isPatch(storage);
	}
