 ...
 * @since 3.0
 */
public class SynchronizeDialog extends ResizableDialog {
		
	private ICompareContainer input;
	 ...
	 */
	public SynchronizeDialog(Shell shell, String title, ICompareContainer input) {
		super(shell, null);
		this.title = title;
		this.input = input;
	}
