...
public abstract class SynchronizationCacheRefreshOperation {
	...
	protected IResource[] refresh(IResource resource, int depth, boolean cacheFileContentsHint, IProgressMonitor monitor) throws TeamException {
		...
		try {
			...
			IResourceVariant	tree = getRemoteTree(resource, depth, cacheFileContentsHint, Policy.subMonitorFor(monitor, 70));
	...
	protected void collectChanges(IResource local, IResourceVariant remote, Collection changedResources, int depth, IProgressMonitor monitor) throws TeamException {
	...
	protected Map mergedMembers(IResource local, IResourceVariant remote, IProgressMonitor progress) throws TeamException {
	 ...
	 */
	protected abstract byte[] getRemoteSyncBytes(IResource local, IResourceVariant remote) throws TeamException;
	 ...
	 */
	protected abstract IResourceVariant[] getRemoteChildren(IResourceVariant remote, IProgressMonitor progress) throws TeamException;
	 ...
	 */
	protected abstract IResourceVariant getRemoteTree(IResource resource, int depth, boolean cacheFileContentsHint, IProgressMonitor monitor) throws TeamException;
